                ...
                tabBarIcon: ({ focused, color, size }) => {
                    ...
                    return (
                     ...
                     <TouchableOpacity onPress={handleCameraPermission} style={{ gap: 4, alignItems: "center", backgroundColor:'white', padding:scale(25), borderRadius:scale(50) }}>
                        ...
                        :
                        <View style={{ gap: scale(4),minWidth:scale(30), alignItems: "center"}}>
                            <Image style={{
                                maxWidth: scale(20),
                                resizeMode: 'contain',
                                maxHeight: scale(20),
                            ...
                            <Text style={{ fontSize: 12, lineHeight: 18, color: focused ? 'black' : 'white' }}> {route.name.toLocaleLowerCase()=="main"?"Profile":route.name=="Awards"?"Badges":route.name} </Text>
                        </View>}
                        </>
                    );
                }
