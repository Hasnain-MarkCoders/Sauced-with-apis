import { ImageBackground, SafeAreaView, Text, View, Keyboard, ActivityIndicator, Vibration, Alert, Image, TouchableOpacity } from 'react-native'
  ...
  
                  {
                    index == 0 && <View style={{
                      marginBottom: scale(20)
                        ...
                        Wed July 31, 2024 at 3:00 PM - Thu, August 01, 2024 at 3:00 PM
                        </Text>
                            </View>
                        <View style={{
                            flexDirection:"row",
